...
!IF "$(CFG)" != "OdbcInfo - Win32 Release" && "$(CFG)" !=\
 "OdbcInfo - Win32 Debug"
...
CPP_PROJ=/nologo /MT /W3 /GX /O2 /D "WIN32" /D "NDEBUG" /D "_WINDOWS" /D\
 "_MBCS" /Fp"$(INTDIR)/odbcinfo.pch" /Yu"stdafx.h" /Fo"$(INTDIR)/"\
 /Fd"$(INTDIR)/" /FD /c 
CPP_OBJS=.\Release/
CPP_SBRS=.
...
LINK32_FLAGS=/nologo /subsystem:windows /incremental:no\
 /pdb:"$(OUTDIR)/odbcinfo.pdb" /machine:I386 /out:"$(OUTDIR)/odbcinfo.exe" 
LINK32_OBJS= \
	"$(INTDIR)\AboutDlg.obj" \
	"$(INTDIR)\catsets.obj" \
	"$(INTDIR)\DrvInfo.obj" \
...
CPP_PROJ=/nologo /MTd /W3 /Gm /GX /Zi /Od /D "WIN32" /D "_DEBUG" /D "_WINDOWS"\
 /D "_MBCS" /FR"$(INTDIR)/" /Fp"$(INTDIR)/odbcinfo.pch" /Yu"stdafx.h"\
...
LINK32_FLAGS=/nologo /subsystem:windows /incremental:yes\
 /pdb:"$(OUTDIR)/odbcinfo.pdb" /debug /machine:I386\
 /out:"$(OUTDIR)/odbcinfo.exe" 
LINK32_OBJS= \
	"$(INTDIR)\AboutDlg.obj" \
	"$(INTDIR)\catsets.obj" \
	"$(INTDIR)\DrvInfo.obj" \
...
"$(INTDIR)\catsets.obj" : $(SOURCE) $(DEP_CPP_CATSE) "$(INTDIR)"\
 "$(INTDIR)\odbcinfo.pch"
...
"$(INTDIR)\catsets.obj"	"$(INTDIR)\catsets.sbr" : $(SOURCE) $(DEP_CPP_CATSE)\
 "$(INTDIR)" "$(INTDIR)\odbcinfo.pch"
...
"$(INTDIR)\DrvInfo.obj" : $(SOURCE) $(DEP_CPP_DRVIN) "$(INTDIR)"\
 "$(INTDIR)\odbcinfo.pch"
...
"$(INTDIR)\DrvInfo.obj"	"$(INTDIR)\DrvInfo.sbr" : $(SOURCE) $(DEP_CPP_DRVIN)\
 "$(INTDIR)" "$(INTDIR)\odbcinfo.pch"
...
"$(INTDIR)\MySheet.obj" : $(SOURCE) $(DEP_CPP_MYSHE) "$(INTDIR)"\
 "$(INTDIR)\odbcinfo.pch"
...
"$(INTDIR)\MySheet.obj"	"$(INTDIR)\MySheet.sbr" : $(SOURCE) $(DEP_CPP_MYSHE)\
 "$(INTDIR)" "$(INTDIR)\odbcinfo.pch"
...
"$(INTDIR)\OdbcInfo.obj" : $(SOURCE) $(DEP_CPP_ODBCI) "$(INTDIR)"\
 "$(INTDIR)\odbcinfo.pch"
...
"$(INTDIR)\OdbcInfo.obj"	"$(INTDIR)\OdbcInfo.sbr" : $(SOURCE) $(DEP_CPP_ODBCI)\
 "$(INTDIR)" "$(INTDIR)\odbcinfo.pch"
...
"$(INTDIR)\OdbcInfo.res" : $(SOURCE) $(DEP_RSC_ODBCIN) "$(INTDIR)"
	$(RSC) $(RSC_PROJ) $(SOURCE)
...
"$(INTDIR)\StdAfx.obj"	"$(INTDIR)\odbcinfo.pch" : $(SOURCE) $(DEP_CPP_STDAF)\
 "$(INTDIR)"
	$(CPP) /nologo /MT /W3 /GX /O2 /D "WIN32" /D "NDEBUG" /D "_WINDOWS" /D "_MBCS"\
 /Fp"$(INTDIR)/odbcinfo.pch" /Yc"stdafx.h" /Fo"$(INTDIR)/" /Fd"$(INTDIR)/" /FD\
 /c $(SOURCE)
...
"$(INTDIR)\StdAfx.obj"	"$(INTDIR)\StdAfx.sbr"	"$(INTDIR)\odbcinfo.pch" : \
$(SOURCE) $(DEP_CPP_STDAF) "$(INTDIR)"
	$(CPP) /nologo /MTd /W3 /Gm /GX /Zi /Od /D "WIN32" /D "_DEBUG" /D "_WINDOWS"\
 /D "_MBCS" /FR"$(INTDIR)/" /Fp"$(INTDIR)/odbcinfo.pch" /Yc"stdafx.h"\
